...
public class RandomUtils {
    ...
    private static String GIRLS =
            "秀娟英华慧巧美娜静淑惠珠翠雅芝玉萍红娥玲" +
            "芬芳燕彩春菊兰凤洁梅琳素云莲真环雪荣爱妹" +
            "霞香月莺媛艳瑞凡佳嘉琼勤珍贞莉桂娣叶璧璐" +
            "娅琦晶妍茜秋珊莎锦黛青倩婷姣婉娴瑾颖露瑶" +
            "怡婵雁蓓纨仪荷丹蓉眉君琴蕊薇菁梦岚苑婕馨" +
            "瑗琰韵融园艺咏卿聪澜纯毓悦昭冰爽琬茗羽希" +
            "宁欣飘育滢馥筠柔竹霭凝晓欢霄枫芸菲寒伊亚" +
            "宜可姬舒影荔枝思丽 ";

    /** 男生名 */
    private static String BOYS =
            "伟刚勇毅俊峰强军平保东文辉力明永健世广志" +
            "义兴良海山仁波宁贵福生龙元全国胜学祥才发" +
            "武新利清飞彬富顺信子杰涛昌成康星光天达安" +
            "岩中茂进林有坚和彪博诚先敬震振壮会思群豪" +
            "心邦承乐绍功松善厚庆磊民友裕河哲江超浩亮" +
            "政谦亨奇固之轮翰朗伯宏言若鸣朋斌梁栋维启" +
            "克伦翔旭鹏泽晨辰士以建家致树炎德行时泰盛" +
            "雄琛钧冠策腾楠榕风航弘";
    ...
    public static String createChinese() {
        ...
        highPosition = (int) (176 + Math.random() * 71);
        //位码，0xA0打头，范围第1~94列
        lowPosition = (int) (161 + Math.random() * 94);
        byte[] bArr = new byte[2];
        bArr[0] = highPosition.byteValue();
        bArr[1] = lowPosition.byteValue();
        try {
            //区位码组合成汉字
    ...
    public static String createChinese(int length) {
        StringBuilder builder = new StringBuilder();
        for (int i = 0; i < length; i++) {
            builder.append(createChinese());
        }
